...
# --- YENİ: SCRIPT VERSİYONU ---
SCRIPT_VERSION = "v2.6 - get_db_url DAHİL"
# -------------------------------
...
def show_license_info(license_data):
    ...
    # --- YENİ: VERSİYON KANITI ---
    print(f"  Script Versiyonu: {THEME_COLOR}{SCRIPT_VERSION}")
    # ----------------------------
    
    print(ACCENT_COLOR + "---------------------------")

# ... (Kodun geri kalanı aynı, buraya ekleyerek kalabalık yapmıyorum) ...
