...
# --- YENİ DÜZENLEME: ANA ÇALIŞTIRMA FONKSİYONU ---
# Artık kodun ana mantığı bu fonksiyona sarılı.
# Launcher bu fonksiyonu ismen çağıracak.
def run_main_app():
    try:
        clear_screen() 
        print_header()
...
# --- YENİ DÜZENLEME: Artık 'if __name__ == "__main__":' bloğu yok.